...
#include "flatfish_ros_efuse_serial/msg/detail/cmd_channel__rosidl_typesupport_fastrtps_c.h"
...
using _CmdChannel__ros_msg_type = flatfish_ros_efuse_serial__msg__CmdChannel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CmdChannel__ros_msg_type * ros_message = static_cast<const _CmdChannel__ros_msg_type *>(untyped_ros_message);
  // Field name: channel
  {
    size_t size = 8;
    auto array_ptr = ros_message->channel;
  ...
  void * untyped_ros_message)
{
  ...
  _CmdChannel__ros_msg_type * ros_message = static_cast<_CmdChannel__ros_msg_type *>(untyped_ros_message);
  // Field name: channel
  {
    size_t size = 8;
    auto array_ptr = ros_message->channel;
...
static uint32_t _CmdChannel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flatfish_ros_efuse_serial__msg__CmdChannel(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flatfish_ros_efuse_serial__msg__CmdChannel;
    is_plain =
      (
...
static size_t _CmdChannel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flatfish_ros_efuse_serial__msg__CmdChannel(
...
static message_type_support_callbacks_t __callbacks_CmdChannel = {
...
static rosidl_message_type_support_t _CmdChannel__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CmdChannel,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, msg, CmdChannel)() {
  return &_CmdChannel__type_support;
}
