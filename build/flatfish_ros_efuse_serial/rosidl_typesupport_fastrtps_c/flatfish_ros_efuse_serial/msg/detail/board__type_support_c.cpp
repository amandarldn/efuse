...
#include "flatfish_ros_efuse_serial/msg/detail/board__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // channels, name
#include "rosidl_runtime_c/string_functions.h"  // channels, name

// forward declare type support functions


using _Board__ros_msg_type = flatfish_ros_efuse_serial__msg__Board;
  ...
  // Field name: channels
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'channels'\n");
        return false;
      }
    }
  }
...
static uint32_t _Board__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flatfish_ros_efuse_serial__msg__Board(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flatfish_ros_efuse_serial__msg__Board;
    is_plain =
      (
...
static size_t _Board__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flatfish_ros_efuse_serial__msg__Board(
