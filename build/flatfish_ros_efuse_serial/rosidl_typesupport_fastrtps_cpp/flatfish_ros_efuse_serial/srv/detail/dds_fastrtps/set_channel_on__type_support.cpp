...
#include "flatfish_ros_efuse_serial/srv/detail/set_channel_on__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flatfish_ros_efuse_serial::srv::SetChannelOn_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flatfish_ros_efuse_serial::srv::SetChannelOn_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flatfish_ros_efuse_serial::srv::SetChannelOn_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetChannelOn_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const flatfish_ros_efuse_serial::srv::SetChannelOn_Request *>(
...
static size_t _SetChannelOn_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetChannelOn_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetChannelOn_Request__callbacks = {
...
static rosidl_message_type_support_t _SetChannelOn_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetChannelOn_Request__callbacks,
...
{
  return &flatfish_ros_efuse_serial::srv::typesupport_fastrtps_cpp::_SetChannelOn_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = flatfish_ros_efuse_serial::srv::SetChannelOn_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flatfish_ros_efuse_serial::srv::SetChannelOn_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<flatfish_ros_efuse_serial::srv::SetChannelOn_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetChannelOn_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const flatfish_ros_efuse_serial::srv::SetChannelOn_Response *>(
...
static size_t _SetChannelOn_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetChannelOn_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetChannelOn_Response__callbacks = {
  "flatfish_ros_efuse_serial::srv",
...
static rosidl_message_type_support_t _SetChannelOn_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetChannelOn_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &flatfish_ros_efuse_serial::srv::typesupport_fastrtps_cpp::_SetChannelOn_Response__handle;
}
...
static service_type_support_callbacks_t _SetChannelOn__callbacks = {
  "flatfish_ros_efuse_serial::srv",
  "SetChannelOn",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flatfish_ros_efuse_serial, srv, SetChannelOn_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flatfish_ros_efuse_serial, srv, SetChannelOn_Response)(),
...
static rosidl_service_type_support_t _SetChannelOn__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetChannelOn__callbacks,
...
{
  return &flatfish_ros_efuse_serial::srv::typesupport_fastrtps_cpp::_SetChannelOn__handle;
}
