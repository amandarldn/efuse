...
bool flatfish_ros_efuse_serial__msg__board__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flatfish_ros_efuse_serial.msg._board.Board", full_classname_dest, 42) == 0);
  }
  flatfish_ros_efuse_serial__msg__Board * ros_message = _ros_message;
  {  // name
  ...
  {  // channels
    ...
    }
    {
      ...
      Py_ssize_t size = 8;
      rosidl_runtime_c__String * dest = ros_message->channels;
...
PyObject * flatfish_ros_efuse_serial__msg__board__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("flatfish_ros_efuse_serial.msg._board");
  ...
  {  // channels
    PyObject * field = NULL;
    size_t size = 8;
    rosidl_runtime_c__String * src = ros_message->channels;
