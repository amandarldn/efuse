...
static const _SetChannelOn_Request_type_support_symbol_names_t _SetChannelOn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Request)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::SetChannelOn_Request_message_type_support_handle;
}
...
static const _SetChannelOn_Response_type_support_symbol_names_t _SetChannelOn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, SetChannelOn_Response)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::SetChannelOn_Response_message_type_support_handle;
}
...
static const _SetChannelOn_type_support_symbol_names_t _SetChannelOn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, SetChannelOn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, SetChannelOn)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, SetChannelOn)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::SetChannelOn_service_type_support_handle;
}
