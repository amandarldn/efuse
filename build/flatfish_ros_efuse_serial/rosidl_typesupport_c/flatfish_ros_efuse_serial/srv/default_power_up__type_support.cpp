...
static const _DefaultPowerUp_Request_type_support_symbol_names_t _DefaultPowerUp_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Request)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::DefaultPowerUp_Request_message_type_support_handle;
}
...
static const _DefaultPowerUp_Response_type_support_symbol_names_t _DefaultPowerUp_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp_Response)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::DefaultPowerUp_Response_message_type_support_handle;
}
...
static const _DefaultPowerUp_type_support_symbol_names_t _DefaultPowerUp_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, flatfish_ros_efuse_serial, srv, DefaultPowerUp)() {
  return &::flatfish_ros_efuse_serial::srv::rosidl_typesupport_c::DefaultPowerUp_service_type_support_handle;
}
